    ...
    <script type="text/javascript">
        $(function () {
            ...
            jv.page().flexiView = function (id) {
                ...
                Boxy.load("~/Admin/PersonAnnex/Detail/" + id + ".aspx", { filter: ".Main", modal: true, title: "查看详细" }, function (bxy) {
            ...
            jv.page().flexiAdd = function () {
                ...
                Boxy.load("~/Admin/PersonAnnex/Add" + ".aspx", { filter: ".Main", modal: true, title: "添加" }, function (bxy) {
            ...
            jv.page().flexiEdit = function (id) {
                ...
                Boxy.load("~/Admin/PersonAnnex/Update/" + id + ".aspx", { filter: ".Main", modal: true, title: "修改" }, function (bxy) {
            ...
            jv.page().flexiDel = function (ids, grid) {
                //删除。
                $.post("~/Admin/PersonAnnex/Delete.aspx", { query: ids.join(",") }, function (res) {
            ...
            myGrid.flexigrid({
                ...
                colModel: [
                     ...
                     { display: "UserID", name: "UserID", width: 80, sortable: true },
                     { display: "Key", name: "Key", width: 80, sortable: true },
                     { display: "AnnexID", name: "AnnexID", width: 80, sortable: true },
                     { display: "SortID", name: "SortID", width: 80, sortable: true },
            ...
            myGrid.getFlexi().p.url = "~/Admin/PersonAnnex/Query" + (jv.page()["uid"] ? "/" + jv.page()["uid"] : "") + ".aspx";
