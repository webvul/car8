    ...
    <script type="text/javascript">
        $(function () {
            ...
            jv.page().flexiDetail = function (id) {
                Boxy.load("~/Admin/PowerTable/Detail/" + id + ".aspx",
            ...
            jv.page().flexiAdd = function () {
                Boxy.load("~/Admin/PowerTable/Add" + ".aspx",
            ...
            jv.page().flexiUpdate = function (id) {
                Boxy.load("~/Admin/PowerTable/Update/" + id + ".aspx",
            ...
            jv.page().flexiDel = function (ids) {
                //删除。
                $.post("~/Admin/PowerTable/Delete" + ".aspx", { query: ids.join(",") }, function (res) {
                    if (res.msg) {
                        alert(res.msg);
                    }
                    else {
            ...
            myGrid.flexigrid({
                title: "表元数据列表标题",
                url: "",
                role: { id: "Id", name: "Id" },  //id : 在被引用的时候,返回的Id值 ; name :在被引用的时候,返回的显示值.
                useId: true,
                colModel: [
                    { display: "Id", name: "Id", width: "auto", align: "center" },
                    { display: "表名", name: "Table", width: "auto", align: "center" },
                    { display: "描述", name: "Descr", width: "auto", align: "center" },
            ...
            myGrid.getFlexi().p.url = "~/Admin/PowerTable/Query" + (jv.page()["uid"] ? "/" + jv.page()["uid"] : "") + ".aspx";
            myGrid.getFlexi().populate();
        }); 
    </script>
</asp:Content>
