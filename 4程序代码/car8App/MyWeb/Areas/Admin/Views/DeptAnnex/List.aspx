    ...
    <script type="text/javascript">
        $(function () {
            ...
            jv.page().flexiView = function (id) {
                ...
                Boxy.load("~/Admin/DeptAnnex/Detail/" + id + ".aspx", { filter: ".Main", modal: true, title: "查看详细" }, function (bxy) {
            ...
            jv.page().flexiAdd = function () {
                ...
                Boxy.load("~/Admin/DeptAnnex/Add" + ".aspx", { filter: ".Main", modal: true, title: "添加" }, function (bxy) {
            ...
            jv.page().flexiEdit = function (id) {
                ...
                Boxy.load("~/Admin/DeptAnnex/Update/" + id + ".aspx", { filter: ".Main", modal: true, title: "修改" }, function (bxy) {
            ...
            jv.page().flexiDel = function (ids, grid) {
                //删除。
                $.post("~/Admin/DeptAnnex/Delete.aspx", { query: ids.join(",") }, function (res) {
            ...
            myGrid.flexigrid({
                ...
                colModel: [
                     ...
                     { display: "照片", name: "AnnexFullName", width: 120, sortable: true, format: '<img width="100px" src="$#$" />' },
            ...
            myGrid.getFlexi().p.url = "~/Admin/DeptAnnex/Query" + (jv.page()["uid"] ? "/" + jv.page()["uid"] : "") + ".aspx";
