...
<asp:Content ID="Content3" ContentPlaceHolderID="HeadContent" runat="server"> 
    <script type="text/javascript">
            ...
            function flexiView(id) {
                ...
                Boxy.load("~/Admin/Stock/Detail/" + id +".aspx", { filter: ".Main", modal: true, title: "查看详细"}, function (bxy) {
            ...
            function flexiAdd() {
                ...
                Boxy.load("~/Admin/Stock/Add" +".aspx", { filter: ".Main", modal: true, title: "添加"}, function (bxy) {
            ...
            function flexiEdit(id) {
                ...
                Boxy.load("~/Admin/Stock/Update/" + id +".aspx", { filter: ".Main", modal: true, title: "修改"}, function (bxy) {
            ...
            function flexiDel(ids, grid) {
                //删除。
                $.post("~/Admin/Stock/Delete.aspx", { query: ids.join(",") }, function (res) {
            ...
            $(function () {
                $(".myGrid:last").flexigrid({
                    ...
                    colModel: [
                     ...
                     { display: "Title", name: "Title", width: 80, sortable: true, align: "center" },
                     { display: "Detail", name: "Detail", width: 80, sortable: true, align: "center" },
                     { display: "Number", name: "Number", width: 80, sortable: true, align: "center" },
                     ...
                     { display: "Lang", name: "Lang", width: 80, sortable: true, align: "center" },
                ...
                $(".myGrid:last").getFlexi().p.url = "~/Admin/Stock/Query" + (jv.page()["uid"] ? "/" + jv.page()["uid"] : "") + ".aspx";
