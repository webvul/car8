...
Calendar = function () {
    ...
    function $_Unkown(a, b, c) {
        if (b instanceof Array) for (var d = b.length; --d >= 0; ) $_Unkown(a, b[d], c);
        else Y(b, c, a ? c : null);
        return a;
    }
    function Z(a, b) {
    ...
    function GetDateTimeFormat(a, b) {
        var c = a.getMonth(),
        d = a.getDate(),
        e = a.getFullYear(),
        f = M(a),
        ...
        return b.replace(n, function (a) { return o.hasOwnProperty(a) ? o[a] : a });
    }
    function Q_UnKown(a, b, c) {
        var d = a.getFullYear(),
        e = a.getMonth(),
        f = a.getDate(),
        g = b.getFullYear(),
    ...
    function E(a, b) {
        ...
        if (c) {
            ...
            if (d && !c.getAttribute("disabled")) if (!a || !this._bodyAnim || d != "date") {
                ...
                (d != "date" || this.selection.type) && $_Unkown(a, c, e),
                d == "date" && ($_Unkown(a, c.parentNode.parentNode, "DynarchCalendar-hover-week"), this._showTooltip(c.getAttribute("dyc-date"))),
                /^time-hour/.test(d) && $_Unkown(a, this.els.timeHour, "DynarchCalendar-hover-time"),
                /^time-min/.test(d) && $_Unkown(a, this.els.timeMinute, "DynarchCalendar-hover-time"),
    ...
    function z(a, b) {
        a._menuVisible = b,
        $_Unkown(b, a.els.title, "DynarchCalendar-pressed-title");
        var c = a.els.menu;
    ...
    function n(a) {
        return "<div unselectable='on'>" + GetDateTimeFormat(a.date, a.args.titleFormat) + "</div>";
    }
    function m(a) {
    ...
    function a(b) {
        ...
        //Udi 添加
        if ($("#" + b.trigger).data("jscal2")) return;
        ...
        this.date = GetDate(b.date),
        this.time = b.time,
        this.fdow = b.fdow,
        BindEvent("onChange onSelect onTimeChange onFocus onBlur".split(/\s+/),
        function (a) {
            var d = b[a];
    ...
    h.moveTo = function (a, b) {
        var c = this;
        a = GetDate(a);
        var d = Q_UnKown(a, c.date, !0),
        e,
        f = c.args,
        g = f.min && Q_UnKown(a, f.min),
        h = f.max && Q_UnKown(a, f.max);
        f.animation || (b = !1),
        $_Unkown(g != null && g <= 1, [c.els.navPrevMonth, c.els.navPrevYear], "DynarchCalendar-navDisabled"),
        $_Unkown(h != null && h >= -1, [c.els.navNextMonth, c.els.navNextYear], "DynarchCalendar-navDisabled"),
        g < -1 && (a = f.min, e = 1, d = 0),
        h > 1 && (a = f.max, e = 2, d = 0),
        c.date = a,
        c.refresh(!!b),
    ...
    h.isDisabled = function (a) {
        var b = this.args;
        return b.min && Q_UnKown(a, b.min) < 0 || b.max && Q_UnKown(a, b.max) > 0 || b.disabled(a);
    },
    ...
    h._showTooltip = function (a) {
        ...
        a && (a = P(a), c = this.args.dateInfo(a), c && c.tooltip && (b = "<div class='DynarchCalendar-tooltipCont'>" + GetDateTimeFormat(a, c.tooltip) + "</div>")),
        d.innerHTML = b
    };
    ...
    (a.Selection = function (a, b, c, d) {
        ...
        selectRange: function (b, c) {
            ...
            try {
                BindEvent((new a.Selection([[b, c]], a.SEL_MULTIPLE, bl)).getDates(), bb(function (a) {
        ...
        print: function (a, b) {
            ...
            e instanceof Array ? c.push(GetDateTimeFormat(P(e[0], f, g), a) + b + GetDateTimeFormat(P(e[1], f, g), a)) : c.push(GetDateTimeFormat(P(e, f, g), a));
            return c;
        },
        getDates: function (a) {
            var b = [],
            ...
            while (c < this.sel.length) {
                ...
                if (e instanceof Array) {
                    d = P(e[0]),
                    e = e[1];
                    while (O(d) < e) b.push(a ? GetDateTimeFormat(d, a) : new Date(d)),
                    d.setDate(d.getDate() + 1)
                } else d = P(e);
                b.push(a ? GetDateTimeFormat(d, a) : d)
            }
            return b;
        }
    },
