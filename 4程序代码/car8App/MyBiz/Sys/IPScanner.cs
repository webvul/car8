...
namespace MyBiz.Sys
{
    ...
    public class IPScanner
    {
        ...
        private int QQwry()
        {
            ...
            string pattern = "\\b(((?!\\d\\d\\d)\\d+|1\\d\\d|2[0-4]\\d|25[0-5])(\\b|\\.)){4}";
        ...
        //public TRegionRule.Entity GetCityName(string strIp)
        //{

        //    string cityName = string.Empty;
        //    TRegionRule.Entity set = null;
        //    if (strIp != "::1")
        //    {
        //        IPScanner objScan = new IPScanner();

        //        objScan.DataPath = System.Web.HttpContext.Current.Server.MapPath("~/Sys/qqwry.dat");
        //        objScan.IP = strIp;
        //        string strAddress = objScan.IPLocation();
        //        if (strAddress.HasValue())
        //        {
        //            set = dbr.App.TRegion
        //            .SelectWhere(o => new ConstColumn(strAddress).StringIndex(o.Name) >= 0)
        //            .ToEntity(o => o._);
        //        }
        //    }
        ...
        //    if (set == null)
        //    {
        //        set = dbr.App.TRegion.FindFirst(o => o.Name == "北京", o => o._);
        //    }
        ...
        public string GetClientIP()
        {
            ...
            {
                userIP = HttpContext.Current.Request.ServerVariables["HTTP_X_FORWARDED_FOR"].ToString(); //get real client IP
            }
            else //ip  not using proxy or can't get the Client IP
            {
                //得到服务端的地址
                userIP = HttpContext.Current.Request.ServerVariables["REMOTE_ADDR"].ToString(); //While it can't get the Client IP, it will return proxy IP.
            }
