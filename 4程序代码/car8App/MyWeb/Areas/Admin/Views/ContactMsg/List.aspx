    ...
    <script type="text/javascript">
        $(function () {
            ...
            jv.page().flexiView = function (id) {
                ...
                Boxy.load("~/Admin/ContactMsg/Detail/" + id + ".aspx", { filter: ".Main", modal: true, title: "查看详细" }, function (bxy) {
            ...
            jv.page().flexiAdd = function () {
                ...
                Boxy.load("~/Admin/ContactMsg/Add" + ".aspx", { filter: ".Main", modal: true, title: "添加" }, function (bxy) {
            ...
            jv.page().flexiEdit = function (id) {
                ...
                Boxy.load("~/Admin/ContactMsg/Update/" + id + ".aspx", { filter: ".Main", modal: true, title: "修改" }, function (bxy) {
            ...
            jv.page().flexiDel = function (ids, grid) {
                //删除。
                $.post("~/Admin/ContactMsg/Delete.aspx", { query: ids.join(",") }, function (res) {
            ...
            myGrid.flexigrid({
                ...
                colModel: [
                     ...
                     { display: "Subject", name: "Subject", width: 80, sortable: true },
                     { display: "Msg", name: "Msg", width: "auto", sortable: true },
                     { display: "SenderName", name: "SenderName", width: 80, sortable: true },
                     { display: "Url", name: "Url", width: "auto", sortable: true ,format:"<a target='_blank' href='$#$'>$#$</a>"},
                     { display: "AddTime", name: "AddTime", width: 80, sortable: true },
            ...
            myGrid.getFlexi().p.url = "~/Admin/ContactMsg/Query" + (jv.page()["uid"] ? "/" + jv.page()["uid"] : "") + ".aspx";
