...
<asp:Content ID="Content3" ContentPlaceHolderID="HeadContent" runat="server"> 
    <script type="text/javascript">
            ...
            function flexiView(id) {
                ...
                Boxy.load("~/Admin/StockAnnex/Detail/" + id +".aspx", { filter: ".Main", modal: true, title: "查看详细"}, function (bxy) {
            ...
            function flexiAdd() {
                ...
                Boxy.load("~/Admin/StockAnnex/Add" +".aspx", { filter: ".Main", modal: true, title: "添加"}, function (bxy) {
            ...
            function flexiEdit(id) {
                ...
                Boxy.load("~/Admin/StockAnnex/Update/" + id +".aspx", { filter: ".Main", modal: true, title: "修改"}, function (bxy) {
            ...
            function flexiDel(ids, grid) {
                //删除。
                $.post("~/Admin/StockAnnex/Delete.aspx", { query: ids.join(",") }, function (res) {
            ...
            $(function () {
                $(".myGrid:last").flexigrid({
                    ...
                    colModel: [
                     ...
                     { display: "Key", name: "Key", width: 80, sortable: true, align: "center" },
                     { display: "StockID", name: "StockID", width: 80, sortable: true, align: "center" },
                     { display: "AnnexID", name: "AnnexID", width: 80, sortable: true, align: "center" },
                ...
                $(".myGrid:last").getFlexi().p.url = "~/Admin/StockAnnex/Query" + (jv.page()["uid"] ? "/" + jv.page()["uid"] : "") + ".aspx";
