...
(function ($) {
    ...
    $.fn.combobox = function (suggestions, config) {
        ...
        if (!optionsContainer) {
            optionsContainer = $('<ul class="comboboxul" />').appendTo($('body'));
        ...
        $(this).each(function (i) {
            ...
            var button = $('<img class="button" src="' + config.imageUrl + '" />').insertAfter(textBox).click(function () {
                textBox.focus();
            });
            ...
            function show(filter) {
                ...
                optionsContainer.wrap('<div class="comboboxdiv" />');
                ...
                //showing all the options
                    optionsContainer.slideDown("normal");
                else
