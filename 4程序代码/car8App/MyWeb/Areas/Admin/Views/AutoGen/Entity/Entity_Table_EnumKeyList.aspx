...
<asp:Content ID="Content3" ContentPlaceHolderID="HeadContent" runat="server">
    <script type="text/javascript">
        $(function () {
            ...
            myGrid.flexigrid({
                title: "列定义" + jv.page().entity,
                url: "",
                role: { id: "Column", name: "Column" },
                treeOpen: true,
                colModel: [
                    { display: "选择", name: "Select", width: "auto",   html: "选择" },
                    { display: "列名", name: "Column", width: "auto",  align: "left" },
                    { display: "映射类型", name: "Type", width: "auto",  align: "left" },
                    { display: "映射列别名", name: "MapName", width: "auto",  align: "left" }
					],
                dataType: "json",
                buttons: [
					],
            ...
            myGrid.getFlexi().p.url = "~/Admin/AutoGen/EnumKeyQuery.aspx?entity="
