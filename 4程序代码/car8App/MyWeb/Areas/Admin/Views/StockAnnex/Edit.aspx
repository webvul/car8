<%@ Page Language="C#" MasterPageFile="~/Areas/Admin/Views/Shared/Admin.Master" Inherits="MyCon.MyMvcPage<DbEnt.StockAnnexRule.Entity>" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="HeadContent" runat="server">
    <script type="text/javascript">
        ...
        function Edit_OK(ev) {
            ...
            $.post("~/Admin/StockAnnex/" + jv.page()["action"] + "/" + (jv.page()["uid"] || "0") + ".aspx", $(".MyCard").GetDivJson("Edit_"), function (res) {
                //客户端返回的是Json
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table width="100%">
        ...
        <tr>
            ...
            <td class='tdVal'>
                <%=Html.TextBox("Edit_StockID", (Model.StockID))%>
            </td>
            <td class='tdSplit'>
            </td>
            <td class='tdEdit'>
