    ...
    <script type="text/javascript">
        $(function () {
            ...
            jv.page().flexiView = function (id) {
                ...
                Boxy.load("~/Admin/ProductInfo/Detail/" + id + ".aspx", { filter: ".Main", modal: true, title: "查看详细" }, function (bxy) {
            ...
            jv.page().flexiAdd = function () {
                jv.PopList({
                    area: "Admin", entity: "ProductInfo", mode: "check", callback: function (role, data) {
                        var ary = Array();
                        $(data).each(function (i, d) { ary.push(d.id); });
                        $.post("~/Admin/ProductInfo/HotAdd.aspx", { ProductIds: ary.join(",") }, function (res) {
            ...
            jv.page().flexiEdit = function (id) {
                ...
                Boxy.load("~/Admin/ProductInfo/Update/" + id + ".aspx", { filter: ".Main", modal: true, title: "修改" }, function (bxy) {
            ...
            jv.page().flexiDel = function (ids, grid) {
                //删除。
                $.post("~/Admin/ProductInfo/HotDelete.aspx", { query: ids.join(",") }, function (res) {
            ...
            myGrid.getFlexi().p.url = "~/Admin/ProductInfo/HotQuery/" + (jv.page()["uid"] || 0) + ".aspx";
