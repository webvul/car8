    ...
    <script type="text/javascript">
        $(function () {
            ...
            jv.page().flexiView = function (id) {
                ...
                Boxy.load("~/Admin/ProductType/Detail/" + id + ".aspx", { filter: ".Main", modal: true, title: "查看详细" }, function (bxy) {
            ...
            jv.page().flexiAdd = function () {
                ...
                Boxy.load("~/Admin/ProductType/Add" + ".aspx", { filter: ".Main", modal: true, title: "添加", width: 701 });
            };

            jv.page().flexiEdit = function (id) {

                Boxy.load("~/Admin/ProductType/Update/" + id + ".aspx", { filter: ".Main", modal: true, title: "修改", width: 701 });
            };
            ...
            jv.page().flexiDel = function (ids, grid) {
                ...
                //删除。
                $.post("~/Admin/ProductType/Delete.aspx", { query: ids.join(",") }, function (res) {
                    if (!res.msg) {
                        grid.populate();
                        return alert("删除成功 !");
                    }
            ...
            myGrid.getFlexi().p.url = "~/Admin/ProductType/Query" + (jv.page()["uid"] ? "/" + jv.page()["uid"] : "") + ".aspx";
