...
namespace MyOql.MyOql_CodeGen
{
    ...
    public partial class MyOqlCodeGen
    {
        ...
        /// <summary>
        /// 列说明，有四列： ConfigName, TableName，ColumnName，Descr。
        /// </summary>
        static List<StringDict> ColumnDescriptions { get; set; }

        /// <summary>
        /// 表说明，三列： ConfigName, TableName，Descr
        /// </summary>
        static List<StringDict> TableDescriptions { get; set; }

        /// <summary>
        /// 从数据库选出的列。有五列： ConfigName, TableName，ColumnName，Type，Precision，Length，Scale。
        /// </summary>
        static List<StringDict> ColumnDefines { get; set; }
        ...
        static MyOqlCodeGen()
        {
            ...
            ColumnDefines = new List<StringDict>();
            ColumnDescriptions = new List<StringDict>();
            TableDescriptions = new List<StringDict>();
        }
